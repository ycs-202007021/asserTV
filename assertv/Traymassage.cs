...
namespace assertv
{
    public partial class Traymassage : Form
    {
        public Traymassage()
        {
            InitializeComponent();
        ...
        private void lbResult_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            this.Close(); 
            TimerEvent.Stop();
        }
